# Python Temelleri ve OOP Giriş Ders Notları

Bu depo, Python programlama diline sıfırdan başlayıp Nesne Yönelimli Programlama (OOP) mantığının sınırına kadar uzanan süreçte, ders esnasında yazdığım tüm uygulama kodlarını ve çalışma notlarını içermektedir.

Süreci tamamen kendi dilimizde takip edebilmek ve mantığı daha rahat kavrayabilmek adına **kodların tamamı, değişken isimleri, fonksiyon yapıları ve satır arası açıklamaları tamamen Türkçe olarak hazırlanmıştır.**
